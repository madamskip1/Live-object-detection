...
TEST_CASE("3 depth", "[3depthchannels]")
{
	...
	REQUIRE((int)resultPtr[5] == 0);

	REQUIRE((int)resultPtr[6] == 255);
	REQUIRE((int)resultPtr[7] == 255);
	REQUIRE((int)resultPtr[8] == 255);
